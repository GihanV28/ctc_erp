      ...
      <Container>
        <div className="max-w-4xl mx-auto bg-white rounded-lg shadow-lg p-8 md:p-12">
          ...
          <section className="mb-8">
            ...
            <div className="space-y-6">
              ...
              <div>
                ...
                <p className="text-gray-700 mb-2">Help us understand how visitors use our site:</p>
                <ul className="list-disc list-inside space-y-1 text-gray-700">
              ...
              <div>
                ...
                <p className="text-gray-700 mb-2">Remember your preferences:</p>
                <ul className="list-disc list-inside space-y-1 text-gray-700">
              ...
              <div>
                <h3 className="text-xl font-semibold text-gray-900 mb-2">Marketing Cookies (Optional)</h3>
                <p className="text-gray-700 mb-2">Used with your consent for:</p>
                <ul className="list-disc list-inside space-y-1 text-gray-700">
          ...
          <section className="mb-8">
            ...
            <p className="text-gray-700 leading-relaxed mb-4">You can control cookies through:</p>
            <ul className="list-disc list-inside space-y-2 text-gray-700">
              ...
              <li><strong>Opt-Out Tools:</strong> Third-party opt-out mechanisms</li>
            </ul>
          </section>

          <section className="mb-8">
            <h2 className="text-2xl font-bold text-gray-900 mb-4">How to Disable Cookies</h2>
          ...
          <section className="mb-8">
            ...
            <p className="text-gray-700 leading-relaxed mb-4">For questions about our cookie usage:</p>
            <div className="space-y-2 text-gray-700">
