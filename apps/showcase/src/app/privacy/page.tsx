        ...
        <div className="max-w-4xl mx-auto bg-white rounded-lg shadow-lg p-8 md:p-12">
          ...
          <section className="mb-8">
            ...
            <ul className="list-disc list-inside space-y-2 text-gray-700">
              ...
              <li><strong>Shipping Information:</strong> Sender and recipient details, cargo descriptions, delivery addresses</li>
          ...
          <section className="mb-8">
            ...
            <p className="text-gray-700 leading-relaxed mb-4">For privacy concerns, contact us at:</p>
