    ...
    <div className="min-h-screen bg-gray-800 py-32">
      <Container>
        <div className="max-w-4xl mx-auto bg-gray-900 rounded-lg shadow-lg p-8 md:p-12">
          <h1 className="text-4xl font-bold text-gray-300 mb-4">TERMS OF SERVICE</h1>
          <p className="text-sm text-gray-500 mb-8">Effective Date: January 2025</p>

          <section className="mb-8">
            <h2 className="text-2xl font-bold text-gray-400 mb-4">1. Acceptance of Terms</h2>
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-bold text-gray-400 mb-4">2. Services Provided</h2>
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-bold text-gray-400 mb-4">3. Customer Responsibilities</h2>
            <p className="text-gray-500 leading-relaxed mb-4">You agree to:</p>
            <ul className="list-disc list-inside space-y-2 text-gray-500">
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-bold text-gray-400 mb-4">4. Prohibited Items</h2>
            <p className="text-gray-500 leading-relaxed mb-4">We do not ship:</p>
            <ul className="list-disc list-inside space-y-2 text-gray-500">
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-bold text-gray-400 mb-4">5. Pricing and Payment</h2>
            <ul className="list-disc list-inside space-y-2 text-gray-500">
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-bold text-gray-400 mb-4">6. Liability and Insurance</h2>
            <ul className="list-disc list-inside space-y-2 text-gray-500">
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-bold text-gray-400 mb-4">7. Delivery Terms</h2>
            <ul className="list-disc list-inside space-y-2 text-gray-500">
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-bold text-gray-400 mb-4">8. Customs and Duties</h2>
            <ul className="list-disc list-inside space-y-2 text-gray-500">
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-bold text-gray-400 mb-4">9. Cancellation and Refunds</h2>
            <ul className="list-disc list-inside space-y-2 text-gray-500">
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-bold text-gray-400 mb-4">10. Dispute Resolution</h2>
            <p className="text-gray-500 leading-relaxed mb-4">Disputes will be resolved through:</p>
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-bold text-gray-400 mb-4">11. Limitation of Liability</h2>
            <p className="text-gray-500 leading-relaxed mb-4">Our liability is limited to the lesser of:</p>
            <ul className="list-disc list-inside space-y-2 text-gray-500">
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-bold text-gray-400 mb-4">12. Changes to Terms</h2>
            <p className="text-gray-500 leading-relaxed">
