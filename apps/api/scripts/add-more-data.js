...
async function addMoreData() {
  try {
    console.log('📊 Adding more shipments and financial data...\n');
    ...
    const suppliers = await Supplier.find({ status: 'active' }).limit(3);
    ...
    console.log('='.repeat(60));
    console.log('\n✅ Database is ready for comprehensive reporting!');
